...
/// 收藏列表，和文章列表差不多的写法。
class MyCollectArtPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => MyCollectArtPageState();
}

class MyCollectArtPageState extends State<MyCollectArtPage> {
...
//                          .showSnackBar(SnackBar(content: Text("收藏我哦")));
  ...
  void getArticleData(bool isLoadMore) {
    ...
    // 拼接url
    var articleUrl = "${Urls.COLLECT_ARTICLE_LIST}$_curPager/json";
    // 开始请求  来一个请求中的值吧。
    setState(() {
      _isRequesting = true;
    });
